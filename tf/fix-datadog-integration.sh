...
echo "Fixing datadog-aws-integration.tf file..."

# Create a clean version of the file
cat > datadog-aws-integration.tf.new << EOF
...
mv datadog-aws-integration.tf.new datadog-aws-integration.tf

echo "Fixed datadog-aws-integration.tf successfully!" 